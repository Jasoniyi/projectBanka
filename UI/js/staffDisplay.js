// staff dashboard
const activate = document.getElementById('activateAcct');
...
const deactivate = document.getElementById('deactivateAcct');
...
const deleteAcct = document.getElementById('deleteAccts');
